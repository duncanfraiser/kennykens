...
class FileuploadController extends Controller
{
    public function index(){
        ...
        foreach ($fileuploads as $fileupload){
            $img = new \StdClass;
            $img->url  = "http://new.kennykens.df.ercorr.com/" . $fileupload->path;
            $img->thumb = "http://new.kennykens.df.ercorr.com/" . $fileupload->path;
  ...
  //   }
    ...
    public function store(Request $request){
        ...
        $completePath = "http://new.kennykens.df.ercorr.com/".$filepath.$filename;
        $file->save();  
